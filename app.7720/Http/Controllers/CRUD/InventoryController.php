...
class InventoryController extends Controller
{
    ...
    public function create()
    {
        if (Auth::user()->hasPermission('create-inventory')) {
            ...
            $vendors = Vendor::all();
            return view('crm.crud.inventories.create', compact('inventoryStatuses', 'inventoryTypes', 'vendors'));
        } else {
            abort(403, 'Unauthorized Access');
        }
    }
    ...
    public function edit(Inventory $inventory)
    {
        if (Auth::user()->hasPermission('update-inventory')) {
            ...
            $inventoryStatuses = InventoryStatus::all();
            $vendors = Vendor::all();
            return view('crm.crud.inventories.edit', compact('inventoryTypes', 'inventoryStatuses', 'vendors', 'inventory'));
        } else {
            abort(403, 'Unauthorized Access');
        }
    }

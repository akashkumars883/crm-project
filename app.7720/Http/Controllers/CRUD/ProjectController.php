...
class ProjectController extends Controller
{
    ...
    public function create()
    {
        if (Auth::user()->hasPermission('create-project')) {
            ...
            return view('crm.crud.projects.create', compact('projectTypes', 'projectStatuses', 'customers', 'projects', ));
        } else {
            abort(403, 'Unauthorized Access');
        }        
    }
    ...
    public function show(Project $project)
    {
        if (Auth::user()->hasPermission('read-project')) {
            ...
            return view('crm.crud.projects.show', compact('project', 'attachmentTypes', 'projects', 'customers', 'paymentStatuses', 'employees', 'inventories', 'paymentMethods', 'billStatuses', 'billTypes', 'activityTypes', 'contactMethods', 'attachments', 'activities', 'bills', 'payments'));
        } else {
            abort(403, 'Unauthorized Access');
        }       
    }
    ...
    public function edit(Project $project)
    {
        if (Auth::user()->hasPermission('update-project')) {
            ...
            $projectStatuses = ProjectStatus::all();
            $customers = Customer::all();
            return view('crm.crud.projects.edit', compact('projectTypes', 'projectStatuses', 'customers', 'project'));
        } else {
            abort(403, 'Unauthorized Access');
        }
    }

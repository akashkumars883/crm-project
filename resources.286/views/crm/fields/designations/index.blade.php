                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $designation->id }}">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div class="modal fade" id="confirmDeleteModal{{ $designation->id }}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">

                            ...
                            <div class="card-body">
                                <div class="media mb-3">
                                    <div class="media-body align-self-center">
                                        ...
                                        <p class="mb-0 font-12"><i class="fas fa-home"></i> : {{ $project->customer->lead->address }}, {{ $project->customer->city }}, {{ $project->customer->state }} - {{ $project->customer->zip_code }} </p>
                                    </div><!--end media body-->
                                </div> <!--end media-->
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0 font-12">Quote: {{ $project->quote }}</p>
                                <p class="mb-0 font-12">Quote: {{ $project->total_material_cost }}</p>
                                <p class="mb-0 font-12">Quote: {{ $project->administrative_cost }}</p>
                            </div><!--end card-body-->
                        </div>  <!--end card-->
                    </div><!--end col-->
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0 font-12">Total Material Cost: {{ $project->total_material_cost }}</p>
                                <p class="mb-0 font-12">Administrative Cost: {{ $project->administrative_cost }}</p>
                                <p class="mb-0 font-12">Misc Expenses: {{ $project->administrative_cost }}</p>
                                <p class="mb-0 font-12">Total Cost: {{ $project->administrative_cost }}</p>
                                <p class="mb-0 font-12">Result: {{ $project->administrative_cost }}</p>
                                <p class="mb-0 font-12">Final Bill Value: {{ $project->administrative_cost }}</p>
                                <p class="mb-0 font-12">Tax Value: {{ $project->administrative_cost }}</p>

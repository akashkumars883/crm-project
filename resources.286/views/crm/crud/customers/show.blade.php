                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="media mb-3">
                                    <div class="media-body align-self-center">
                                        <p class="mb-0 font-14">Contact Method : {{ $customer->lead->contactMethod ? $lead->contactMethod->name ?? 'Not Assigned' : 'Not Assigned' }} </p>
                                        <p class="mb-0 font-14">Contact Language : {{ $customer->lead->contactLanguage ? $lead->contactLanguage->name ?? 'Not Assigned' : 'Not Assigned' }}</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0 font-14">Assigned To : {{ $customer->lead->assignedTo ? $lead->assignedTo->name ?? 'Not Assigned' : 'Not Assigned' }} </p>

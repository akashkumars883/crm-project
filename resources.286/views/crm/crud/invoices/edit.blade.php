                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="invoice_type_id" id="invoice_type_id" class="form-select @error('invoice_type_id') is-invalid @enderror">
                                    ...
                                    <option value="{{ $invoiceType->id }}" {{ $invoice->invoice_type_id == $invoiceType->id ? 'selected' : '' }}>{{ $invoiceType->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="value" id="value" value="{{ old('value', $invoice->value) }}" class="form-control @error('value') is-invalid @enderror">
                                @error('value')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="lead_id" id="lead_id" class="form-select @error('lead_id') is-invalid @enderror">
                                    ...
                                    <option value="{{ $lead->id }}" {{ $invoice->lead && $invoice->lead->id == $lead->id ? 'selected' : '' }}>{{ $lead->id }} - {{ $lead->name }}</option>
                                    @endforeach
                                </select>
                                @error('lead_id')
                                    <div class="invalid-feedback">{{ $message }}</div>

                    ...
                    <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="skill_paint_id" id="skill_paint_id" class="form-control @error('skill_paint_id') is-invalid @enderror" required>
                                <option value="" disabled selected>Select Skill Paint</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="skill_polish_id" id="skill_polish_id" class="form-control @error('skill_polish_id') is-invalid @enderror" required>
                                <option value="" disabled selected>Select Skill Polish</option>
                                @foreach($skills as $skill)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="photograph" id="photograph" class="form-control @error('photograph') is-invalid @enderror" accept="image/jpeg,image/png" required>
                            @error('photograph')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="file" name="pan" id="pan" class="form-control @error('pan') is-invalid @enderror" accept="image/jpeg,image/png" required>
                            @error('pan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="file" name="aadhaar" id="aadhaar" class="form-control @error('aadhaar') is-invalid @enderror" accept="image/jpeg,image/png,application/pdf" required>
                            @error('aadhaar')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

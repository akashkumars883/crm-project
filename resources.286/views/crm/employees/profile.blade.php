                                    ...
                                    <div class="media mb-3">
                                        <div class="media-body align-self-center">
                                            @if ($employee->photograph)
                                                <img src="{{ asset('storage/' . $employee->photograph) }}" alt="Employee Photograph" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                            @else
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($employee->pan)
                                    <a href="{{ asset('storage/' . $employee->pan) }}" target="_blank" class="badge bg-primary text-decoration-none me-1">PAN</a>
                                    @else
                                        No PAN Uploaded
                                    @endif
                                    @if ($employee->aadhaar)
                                        <a href="{{ asset('storage/' . $employee->aadhaar) }}" target="_blank" class="badge bg-primary text-decoration-none me-1">Aadhaar</a>
                                    @else
                                        No Aadhaar Uploaded
                                    @endif
                                </div><!--end card-body-->

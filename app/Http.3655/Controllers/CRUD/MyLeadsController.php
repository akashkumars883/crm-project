...
class MyLeadsController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Auth::user()->hasPermission('manage-my-lead')) {
            ...
            return view('crm.crud.my-leads.index', compact('leads', 'leadStatusAnalytics', 'leadSourceAnalytics'));
        } else {
    ...
    public function create()
    {
        if (Auth::user()->hasPermission('create-my-lead')) {
            ...
            return view('crm.crud.my-leads.create', compact('leadSources', 'users', 'contactMethods', 'contactLanguages', 'leadStatuses'));
        } else {
            abort(403, 'Unauthorized Access');
        }        
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('my-leads.index');
    }
    ...
    public function show(Lead $lead)
    {
        if (Auth::user()->hasPermission('read-my-lead')) {
            ...
            $contactMethods = ContactMethod::all();
            return view('crm.crud.my-leads.show', compact('lead', 'invoices', 'invoiceStatuses', 'invoiceTypes', 'contactMethods', 'activityTypes', 'activities'));
        } else {
            abort(403, 'Unauthorized Access');
        }
    ...
    public function edit(Lead $lead)
    {
        if (Auth::user()->hasPermission('update-my-lead')) {
            ...
            return view('crm.crud.my-leads.edit', compact('lead', 'contactMethods', 'contactLanguages', 'leadSources', 'leadStatuses', 'users'));
        } else {
            abort(403, 'Unauthorized Access');
        }

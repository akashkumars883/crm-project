            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bills.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Amount -->
                        <div class="mb-3">
                            <label for="amount" class="form-label">Base Amount (Taxable Value)</label>
                            <input type="number" step="0.01" class="form-control" id="amount" name="amount" value="{{ old('amount') }}" required oninput="calcBillTax()">
                        </div>

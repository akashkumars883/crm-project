                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a class="text-dark" href="{{ $customer->lead_id ? route('leads.show', $customer->lead_id) : '#' }}">{{ optional($customer->lead)->name ?? 'N/A' }}</a>
                                    <td>{{ optional($customer->lead)->phone ?? 'N/A' }}</td>
                                    <td>{{ optional($customer->lead)->email ?? 'N/A' }}</td>
                                    <td>{{ optional($customer->lead)->city ?? 'N/A' }}</td>
                                    <td>{{ optional($customer->lead)->state ?? 'N/A' }}</td>
                                    <td>{{ optional($customer->lead)->zip ?? 'N/A' }}</td>
                                    <td>

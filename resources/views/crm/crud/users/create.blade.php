                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 mt-4">
                                <label class="form-label fw-semibold d-block">Assign Roles <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-4 pt-3 border-top text-end">
                            ...
                            <button type="submit" class="btn btn-primary px-4"><i class="ti ti-check"></i> Create User</button>
                        </div>
                    </form>
                </div>
            </div>

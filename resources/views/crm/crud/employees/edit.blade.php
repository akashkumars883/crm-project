                ...
                <div class="card-body">
                    <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="blood_group_id" id="blood_group_id" class="form-control @error('blood_group_id') is-invalid @enderror" >
                        ...
                        <div class="mb-3">
                            ...
                            <select name="skill_paint_id" id="skill_paint_id" class="form-control @error('skill_paint_id') is-invalid @enderror" >
                        ...
                        <div class="mb-3">
                            ...
                            <select name="skill_polish_id" id="skill_polish_id" class="form-control @error('skill_polish_id') is-invalid @enderror" >
                        ...
                        <div class="mb-3">
                            ...
                            @if ($employee->photograph)
                                <div class="mt-2">
                                    <img src="{{ (\Illuminate\Support\Str::startsWith($employee->photograph, 'http') ? $employee->photograph : asset('storage/' . $employee->photograph)) }}" alt="Photograph" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            @endif
                        </div>
                        <div class="mb-3">
                            ...
                            @if ($employee->pan)
                                <div class="mt-2">
                                    <img src="{{ (\Illuminate\Support\Str::startsWith($employee->pan, 'http') ? $employee->pan : asset('storage/' . $employee->pan)) }}" alt="PAN Card" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            @endif
                        </div>
                        <div class="mb-3">
                            ...
                            @if ($employee->aadhaar)
                                <div class="mt-2">
                                    @if (pathinfo($employee->aadhaar, PATHINFO_EXTENSION) === 'pdf')
                                        <a href="{{ (\Illuminate\Support\Str::startsWith($employee->aadhaar, 'http') ? $employee->aadhaar : asset('storage/' . $employee->aadhaar)) }}" target="_blank">View Aadhaar (PDF)</a>
                                    @else
                                        <img src="{{ (\Illuminate\Support\Str::startsWith($employee->aadhaar, 'http') ? $employee->aadhaar : asset('storage/' . $employee->aadhaar)) }}" alt="Aadhaar" class="img-thumbnail" style="max-width: 200px;">
                                    @endif
                                </div>
                            @endif
                        </div>

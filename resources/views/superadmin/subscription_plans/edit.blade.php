...
<div class="p-3 bg-light">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('superadmin.subscription_plans.update', $subscriptionPlan->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_customers') is-invalid @enderror" id="max_customers" name="max_customers" value="{{ old('max_customers', $subscriptionPlan->max_customers) }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_projects') is-invalid @enderror" id="max_projects" name="max_projects" value="{{ old('max_projects', $subscriptionPlan->max_projects) }}" required>
                        ...
                        <div class="mb-3 form-check form-switch form-switch-success">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $subscriptionPlan->is_active) ? 'checked' : '' }}>

<ul class="navigation-menu flex-grow-1 mb-0">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu animate slideIn" aria-labelledby="salesMenu">
            ...
            <li><a href="{{ route('my-leads.index') }}" class="dropdown-item">My Leads</a></li>
            ...
            <li><a href="{{ route('my-projects.index') }}" class="dropdown-item">My Projects</a></li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu animate slideIn" aria-labelledby="ticketsMenu">
            ...
            <li><a href="{{ route('my-tickets.index') }}" class="dropdown-item">My Tickets</a></li>
        </ul>
    </li>
</ul>

                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-0 font-12">
                                    @if ($result['profitLossPercentage'] > 0)
                                        Profit Percentage: {{ $result['profitLossPercentage'] }}%
                                    @elseif ($result['profitLossPercentage'] < 0)
                                        Loss Percentage: {{ abs($result['profitLossPercentage']) }}%
                                    @else
                                        No Profit, No Loss
                                    @endif
                                </p>
                        ...
                        <div class="row d-flex justify-content-center">                                                
                            <div class="col-9">
                                @if ($result['profitLossPercentage'] > 0)
                                    ...
                                    <h3 class="my-1 font-20 text-success fw-bold">{{ $result['profitLossPercentage'] }}</h3>
                                    <p class="mb-0 text-truncate text-muted">Percentage</p>
                                @elseif ($result['profitLossPercentage'] < 0)
                                    <p class="text-dark mb-0 fw-semibold">Loss %</p>
                                    <h3 class="my-1 text-danger font-20 fw-bold">{{ abs($result['profitLossPercentage']) }}</h3>
                                    <p class="mb-0 text-truncate text-muted">Percentage</p>
                                @else
                                    <p class="text-dark mb-0 fw-semibold">Result</p>
                                    <h3 class="my-1 font-20 text-dark fw-bold">No Data</h3>

                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        <a href="{{ route('my-leads.edit', $lead->id) }}" class="btn  btn-primary btn-square">Update</a>
                                        @if ($lead->customer)
                                        ...
                                        @else
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#customerModal">Convert to Customer</button>
                                        @endif
                                        <a href="{{ route('my-leads.index') }}" class="btn btn-primary  btn-square">Back</a>
                                    </div><!--end col-->
                                </div>  <!--end row-->
                            </div><!--end card-body-->
                        </div>  <!--end card-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('crm.crud.my-leads.show_invoice_form')
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('crm.crud.my-leads.create_customer_form')
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('crm.crud.my-leads.show_activity_form')
            </div>
        </div>
    </div>
</div>

                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $skill->id }}">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div class="modal fade" id="confirmDeleteModal{{ $skill->id }}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
